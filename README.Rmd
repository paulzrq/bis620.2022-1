...
The goal of bis620.2022 is to check the kb_accel data, and the package also includes functions that can plot the ukb_accel data with logarithm or without logarithm, with or without Fourier Transform.
